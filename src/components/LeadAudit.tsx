...
export default function LeadAudit() {
  ...
  return (
    <section id="audit" className="py-24 relative overflow-hidden bg-gradient-to-b from-[#030712] via-[#0B0F19] to-[#030712]">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="p-8 sm:p-12 rounded-3xl bg-[#0B0F19]/90 border border-amber-500/30 shadow-2xl backdrop-blur-2xl relative">
          {/* Subtle Ambient Glow */}
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                  <div>
                    ...
                    <input
                      ...
                      className="w-full bg-white/[0.04] border border-white/10 rounded-xl px-4 py-3 text-sm text-white placeholder-gray-500 focus:outline-none focus:border-amber-400 transition-colors"
                      required
                    />
                  </div>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-6">
                  <div>
                    ...
                    <select
                      ...
                      className="w-full bg-[#111827] border border-white/10 rounded-xl px-4 py-3 text-sm text-white focus:outline-none focus:border-amber-400 transition-colors"
                    >
                ...
                <div>
                  ...
                  <textarea
                    ...
                    className="w-full bg-white/[0.04] border border-white/10 rounded-xl px-4 py-3 text-sm text-white placeholder-gray-500 focus:outline-none focus:border-amber-400 transition-colors resize-none"
                    required
                  />
                </div>
                ...
                <div className="pt-2 flex flex-col sm:flex-row items-center justify-between gap-4">
                  ...
                  <button
                    type="submit"
                    disabled={loading}
                    className="w-full sm:w-auto bg-gradient-to-r from-amber-500 to-orange-500 hover:from-amber-400 hover:to-orange-400 text-black font-extrabold text-sm px-8 py-3.5 rounded-xl shadow-lg shadow-amber-500/25 flex items-center justify-center gap-2 transition-all disabled:opacity-50"
                  >
                    {loading ? (
                      <>
